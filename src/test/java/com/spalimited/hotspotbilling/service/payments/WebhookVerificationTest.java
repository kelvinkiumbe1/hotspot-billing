...
class WebhookVerificationTest {
    ...
    void setUp() {
        ...
        paystack = new PaystackProvider(gateways, null, JSON, null);
        flutterwave = new FlutterwaveProvider(gateways, JSON, null);
        stripe = new StripeProvider(gateways, JSON, null);
    }
