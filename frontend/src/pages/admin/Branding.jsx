                      ...
                      <p className="mt-1">
                        Recommended gateway: <strong>{
                          { MPESA: 'M-Pesa (Daraja)', VODACOM_MPESA: 'M-Pesa (Vodacom)',
                            ...
                            CHAPA: 'Chapa', PAYNOW: 'Paynow', PAYMOB: 'Paymob', KONNECT: 'Konnect', WAAFIPAY: 'WaafiPay (EVC Plus)', CMI: 'CMI', MULTICAIXA: 'Multicaixa Express', CHARGILY: 'Chargily' }[c.rail] || c.rail
